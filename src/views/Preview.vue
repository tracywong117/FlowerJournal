<template>
  <div>
    ...
    <el-popover ref="popoverRef" :visible="popoverVisible" :virtual-ref="buttonRef" virtual-triggering>
      <div class="first-container" v-click-out-side="handleClickOutsideFirst">
        ...
        <el-popover ref="popoverRef1" :visible="popoverVisible1" :virtual-ref="buttonRef1" virtual-triggering>
